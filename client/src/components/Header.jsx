...
const Header = ({ ToggleSidebar, sidebarVisible }) => {
	return (
		...
		>
			...
			<div className="max-w-lg min-w-[60px] h-full flex flex-col justify-around">
				<button
					...
					className={`lg:hidden ${
						sidebarVisible
							? `w-full h-[65%] rounded-md px-2 flex flex-col justify-around items-center
											...
											[&>*]:duration-200 [&>:last-child]:rotate-[135deg] [&>:last-child]:-translate-y-[330%]
											[&>:nth-child(2)]:translate-x-[120%] overflow-x-hidden`
							: `w-full h-[65%] rounded-md px-2 flex flex-col justify-around items-center transition-all
											ease-in-out duration-100 active:scale-95  [&>*]:hover:bg-secondary-yellow [&>*]:transition-all
											[&>*]:duration-200 overflow-x-hidden`
					}`}
				>
